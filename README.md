...
Ewa (Python Software Foundation), Leah (NumFOCUS), Rachel (Drupal Association), Karen (Software Freedom Conservancy), Jory, and Ben (Open Collective) will be hosted by Duane O'Brien (Indeed). Richard Littauer will collect all your questions for the panel.
